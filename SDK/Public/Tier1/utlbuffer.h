...
public:
	...
	CUtlBuffer( const void* pBuffer, long long size, int nFlags = 0 );
	...
	void* PeekPut(long long offset = 0 );
...
// Where am I writing?
//-----------------------------------------------------------------------------
inline long long CUtlBuffer::TellPut( ) const
{
	return m_Put;
}
...
// What's the most I've ever written?
//-----------------------------------------------------------------------------
inline long long CUtlBuffer::TellMaxPut( ) const
{
	return m_nMaxPut;
}
...
// What am I reading?
//-----------------------------------------------------------------------------
inline void* CUtlBuffer::PeekPut(long long offset )
{
...
inline long long CUtlBuffer::Size() const
{ 
