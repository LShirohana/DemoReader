...
CUtlBuffer::CUtlBuffer( const void *pBuffer, long long nSize, int nFlags ) :
...
//-----------------------------------------------------------------------------
bool CUtlBuffer::CheckGet(long long nSize )
{
...
{
	return PutOverflow( nSize );
}

bool CUtlBuffer::OnGetOverflow( int nSize )
{
	return GetOverflow( nSize );
}
