...
public:
	...
	CUtlMemory(long long nGrowSize = 0, long long nInitSize = 0);
	CUtlMemory(T* pMemory, long long numElements);
	CUtlMemory(const T* pMemory, long long numElements);
	~CUtlMemory();

	// Set the size by which the memory grows
	void Init(long long nGrowSize = 0, long long nInitSize = 0);
...
protected:
	...
	T* m_pMemory;
	long long m_nAllocationCount;
	long long m_nGrowSize;
};
...
CUtlMemory<T, I>::CUtlMemory(long long nGrowSize, long long nInitAllocationCount) : m_pMemory(0),
...
template< class T, class I >
CUtlMemory<T, I>::CUtlMemory(T* pMemory, long long numElements) : m_pMemory(pMemory),
...
template< class T, class I >
CUtlMemory<T, I>::CUtlMemory(const T* pMemory, long long numElements) : m_pMemory((T*)pMemory),
	m_nAllocationCount(numElements)
{
	// Special marker indicating externally supplied modifyable memory
...
template< class T, class I >
void CUtlMemory<T, I>::Init(long long nGrowSize /*= 0*/, long long nInitSize /*= 0*/)
{
	Purge();
...
//-----------------------------------------------------------------------------
template< class T, class I >
inline long long CUtlMemory<T, I>::NumAllocated() const
{
	return m_nAllocationCount;
}

template< class T, class I >
inline long long CUtlMemory<T, I>::Count() const
{
	return m_nAllocationCount;
}
