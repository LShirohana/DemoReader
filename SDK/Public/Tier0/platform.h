...
struct CPUInformation
{
	...
	void* m_szProcessorID;				// Processor vendor Identification.
...
//-----------------------------------------------------------------------------
PLATFORM_INTERFACE const void *Plat_GetCommandLine();
#ifndef _WIN32
...
//-----------------------------------------------------------------------------
PLATFORM_INTERFACE void* Plat_SimpleLog( const void* file, int line );
