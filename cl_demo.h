...
#include "CDemoFile.h"
#include "SDK/Public/Tier1/CUtlVector.h"
...
public:
	...
	void*		m_DemoPacket;	// last read demo packet
...
public:
	...
	void	RecordMessages(void* data, int bits); // add messages to current packet
	...
	void	RecordServerClasses(void* pClasses); // packet finished, write all recorded stuff to file
...
public:
	...
	void*		m_MessageData; // temp buffer for all network messages
